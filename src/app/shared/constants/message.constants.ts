export class MessageConstants {
    ...
    public static LOGIN_FAILD = 'Tên đăng nhập hoặc mật khẩu không đúng. Vui lòng kiểm tra lại.';
    ...
    public static CONFIRM_SEND_MSG = 'Bạn có chắc chắn muốn gửi bản ghi này ?';

}

export class ErrorCodeConstant {
    public static AUTHORIZED_ERROR = 401;
}