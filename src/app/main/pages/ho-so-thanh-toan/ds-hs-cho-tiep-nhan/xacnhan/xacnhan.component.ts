...
@Component({
  selector: 'app-xacnhan',
  templateUrl: './xacnhan.component.html',
  styleUrls: ['./xacnhan.component.scss']
})
export class XacnhanComponent extends BaseClass implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<XacnhanComponent>,
