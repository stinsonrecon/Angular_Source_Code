...
@Component({
  selector: 'app-ds-ho-so-tham-tra-cua-toi',
  templateUrl: './ds-ho-so-tham-tra-cua-toi.component.html',
  styleUrls: ['./ds-ho-so-tham-tra-cua-toi.component.scss']
})
export class DsHoSoThamTraCuaToiComponent extends BaseClass implements OnInit {
