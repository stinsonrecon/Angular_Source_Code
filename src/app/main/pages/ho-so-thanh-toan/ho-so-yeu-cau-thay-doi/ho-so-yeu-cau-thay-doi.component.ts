...
@Component({
    selector: 'app-ho-so-yeu-cau-thay-doi',
    templateUrl: './ho-so-yeu-cau-thay-doi.component.html',
    styleUrls: ['./ho-so-yeu-cau-thay-doi.component.scss']
})
export class HoSoYeuCauThayDoiComponent extends BaseClass implements OnInit {
