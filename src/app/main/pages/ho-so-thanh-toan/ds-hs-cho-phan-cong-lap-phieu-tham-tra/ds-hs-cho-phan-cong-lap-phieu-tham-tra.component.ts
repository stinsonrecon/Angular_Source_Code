...
@Component({
  selector: 'app-ds-hs-cho-phan-cong-lap-phieu-tham-tra',
  templateUrl: './ds-hs-cho-phan-cong-lap-phieu-tham-tra.component.html',
  styleUrls: ['./ds-hs-cho-phan-cong-lap-phieu-tham-tra.component.scss']
})
export class DsHsChoPhanCongLapPhieuThamTraComponent extends BaseClass implements OnInit {
