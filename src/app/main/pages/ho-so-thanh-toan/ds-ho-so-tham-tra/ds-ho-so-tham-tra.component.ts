...
@Component({
  selector: 'app-ds-ho-so-tham-tra',
  templateUrl: './ds-ho-so-tham-tra.component.html',
  styleUrls: ['./ds-ho-so-tham-tra.component.scss']
})
export class DsHoSoThamTraComponent extends BaseClass implements OnInit {
