...
@Component({
  selector: 'app-phe-duyet-to-trinh-ke-toan',
  templateUrl: './phe-duyet-to-trinh-ke-toan.component.html',
  styleUrls: ['./phe-duyet-to-trinh-ke-toan.component.scss']
})
export class PheDuyetToTrinhKeToanComponent extends BaseClass implements OnInit {
  searchItem: any = {
    TuKhoa: null,
    DaKy: -99,
    TuNgay: '',
  ...
  constructor(
    ...
    private hoSoService: HoSoToiTaoService
  ) {
    super()
  }
  ...
  view(id: string) {
    this.router.navigate([`/ho-so-thanh-toan/chitiethoso/${id}`, {action: 'TO_TRINH_KE_TOAN'}]);
  }
