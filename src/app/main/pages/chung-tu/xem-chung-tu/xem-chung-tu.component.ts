...
@Component({
  selector: 'app-xem-chung-tu',
  templateUrl: './xem-chung-tu.component.html',
  styleUrls: ['./xem-chung-tu.component.scss']
})
export class XemChungTuComponent extends BaseClass implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<XemChungTuComponent>,
  ...
  ngOnInit(): void {
    ...
    // this.service_.getPdf(this.data.id).pipe(this.unsubsribeOnDestroy).subscribe((rs: any)=>{
