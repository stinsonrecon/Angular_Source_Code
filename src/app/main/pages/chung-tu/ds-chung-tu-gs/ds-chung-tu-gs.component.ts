...
@Component({
  selector: 'app-ds-chung-tu-gs',
  templateUrl: './ds-chung-tu-gs.component.html',
  styleUrls: ['./ds-chung-tu-gs.component.scss']
})
export class DsChungTuGsComponent extends BaseClass implements OnInit {
