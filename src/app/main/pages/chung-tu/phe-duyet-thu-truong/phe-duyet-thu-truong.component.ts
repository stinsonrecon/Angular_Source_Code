...
@Component({
  selector: 'app-phe-duyet-thu-truong',
  templateUrl: './phe-duyet-thu-truong.component.html',
  styleUrls: ['./phe-duyet-thu-truong.component.scss']
})
export class PheDuyetThuTruongComponent extends BaseClass implements OnInit {
  ...
  view(id: string) {
    this.router.navigate([`/ho-so-thanh-toan/chitiethoso/${id}`, { action: 'PHE_DUYET_THU_TRUONG'}]);
  }
