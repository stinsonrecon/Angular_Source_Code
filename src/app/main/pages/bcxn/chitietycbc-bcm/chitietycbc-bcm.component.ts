...
import { DialogViewImageBaocaoBcmComponent } from './dialog-view-image-baocao-bcm/dialog-view-image-baocao-bcm.component';


@Component({
    selector: 'app-chitietycbc-bcm',
    templateUrl: './chitietycbc-bcm.component.html',
    styleUrls: ['./chitietycbc-bcm.component.scss']
})
export class ChitietycbcBcmComponent extends BaseClass implements OnInit {
    ...
    getBcxnById(e?: any) {
        ...
        let donViId: any = [];
        donViId = JSON.parse(localStorage.getItem("user")).idDonVi;
    ...
    openDialogViewImageXacNhan(element: any) {
        ...
        let item: any = JSON.parse(JSON.stringify(element));
        console.log(item);
        const dialogRef = this.dialog.open(DialogViewImageBaocaoBcmComponent, {
            maxWidth: '100vw',
            maxHeight: 'auto',
            height: 'auto',
            width: '98%',
    ...
    goBack() {
        this.router.navigate(['/bcxn/danhsachyeucaubaocaobcm']
        );
    }
    checkRole(id: any) {
